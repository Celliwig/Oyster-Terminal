...
.equ	vector, 0x7000+base			; location to LJMP interrupt vectors
...
.equ	pgm, 0x6000+base			; default location for the user program
.equ	bmem, 0x1000+base			; where is the beginning of memory
.equ	emem, 0x7FFF+base			; end of the memory
...
poweron:
	...
	cpl	a
	mov	p0, a
;	mov	p1, a		; Don't clear (this will disable RAM being used as ROM)
	mov	p2, a
	mov	p3, a
